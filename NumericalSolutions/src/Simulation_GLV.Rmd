---
title: "Lotka Volterra Simulations for 2 particle system"
...
fln_interactions_mat <- "GLV_Simulations/SimpleGLV/interaction_matrix_N_2.mat"
...
df_trajectories <- read.csv("GLV_Simulations/SimpleGLV/df_trajectories_N_2.csv")
df_trajectories %>% 
...
```{r}
df_diversity <- read.csv("GLV_Simulations/SimpleGLV/df_diversity_N_2.csv")
df_diversity %>% 
